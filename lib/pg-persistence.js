...
module.exports = class PgPersistence {
  ...
  async setReminderPreferenceAccquintance(dayPref, weekPref, monthPref) {
    const UPDATE_PREFERENCE_USER = 'UPDATE users' +
                              ' SET dayReminderAccquintance = $1, weekReminderAccquintance = $2, monthReminderAccquintance = $3' + 
                              ' WHERE username = $4';
    let result = await dbQuery(UPDATE_PREFERENCE_USER, dayPref, weekPref, monthPref, this.username)
    return result.rowCount > 0;
  }
